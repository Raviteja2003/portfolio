...
const experienceData: ExperienceItem[] = [
  {
    ...
    description:
      "Responsible for Building and maintaining scalable cloud-powered full-stack applications with secure user modules and optimized API integrations using AWS and React.",
    achievements: [],
    technologies: ["React", "AWS", "TailwindCSS", "TypeScript"],
    type: "full-time",
  },
  {
    id: 1,
